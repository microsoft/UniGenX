...
from edm_qm9_utils.data.prepare.utils import cleanup_file, download_data, is_int
...
def get_unique_charges(charges):
    ...
    charge_counts = {z: np.zeros(len(charges), dtype=int) for z in np.unique(charges)}
